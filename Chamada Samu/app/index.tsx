...
// Importar Stack para controlar o cabeçalho
...
export default function LoginScreen() {
  ...
  const irParaApp = () => {
    // Limpa a pilha e vai para as abas
    // Se 'index' for a rota padrão das abas, isso carrega a tela de Chamada
    router.replace('/(tabs)'); 
  };
  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
      {/* ESTA LINHA CORRIGE O PROBLEMA DA TELA NÃO SUMIR O CABEÇALHO */}
      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.buttonWrapper}>
          <Button 
            title={isLogin ? "ENTRAR" : "CADASTRAR E ENTRAR"} 
            color="#d32f2f" 
            onPress={handleAuth} 
          />
        </View>
